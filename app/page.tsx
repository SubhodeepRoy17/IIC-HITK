      ...
      <section className="py-16 px-4 bg-accent text-accent-foreground">
        <div className="container mx-auto text-center">
          ...
          <p className="text-xl mb-8 opacity-90 max-w-2xl mx-auto">
            Join our thriving community of innovators, entrepreneurs, and change-makers. Let's transform your ideas into
            reality.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
      ...
      <footer className="py-12 px-4 bg-primary text-primary-foreground">
        <div className="container mx-auto">
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              <div className="flex items-center space-x-2 mb-4">
                ...
                <span className="font-bold">HIT IIC</span>
              </div>
              <p className="text-sm opacity-80">
                Heritage Institute of Technology Innovation Council - Fostering innovation and entrepreneurship.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm opacity-80">
                <li>
                  <a href="/members" className="hover:opacity-100 transition-opacity">
                    Members
                  </a>
                </li>
                <li>
                  <a href="/activities" className="hover:opacity-100 transition-opacity">
                    Activities
                  </a>
                </li>
                <li>
                  <a href="/achievements" className="hover:opacity-100 transition-opacity">
                    Achievements
                  </a>
                </li>
                <li>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm opacity-80">
                <li>
                  <a href="/policies" className="hover:opacity-100 transition-opacity">
                    Policies
                  </a>
                </li>
                <li>
                  <a href="/facilities" className="hover:opacity-100 transition-opacity">
                    Facilities
                  </a>
                </li>
                <li>
                  <a href="/grants" className="hover:opacity-100 transition-opacity">
                    Innovation Grants
                  </a>
                </li>
                <li>
                  <a href="/partners" className="hover:opacity-100 transition-opacity">
                    Partners
                  </a>
                </li>
              </ul>
          ...
          <div className="border-t border-primary-foreground/20 mt-8 pt-8 text-center text-sm opacity-80">
            <p>&copy; 2024 Heritage Institute of Technology Innovation Council. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
